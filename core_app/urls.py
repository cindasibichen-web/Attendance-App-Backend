...
from core_app.views.face_views import *
from core_app.views.auth_views import *
from core_app.views.leave_views import *
from core_app.views.attendance_views import *
from core_app.views.project_views import *
from core_app.views.notification_views import *
from core_app.views.google_form_views import *

urlpatterns = [



path('test/', TestEnc.as_view(), name='test-encryption'),
    #   path("google-form-submit/", EmployeeGoogleFormResponse.as_view() ,name="google-form-submit"),
    path("google-form-submit/", google_form_submit, name='google-form-submit'),
    # Auth & Login
    ...
    path('reset-password/', ResetPasswordView.as_view(), name='reset-password'),
     ...
     path("register-session-key/", RegisterSessionKey.as_view()),
    # User
    ...
    path('cancel-leave/', LeaveCancelView.as_view(), name='cancel-leave'),
